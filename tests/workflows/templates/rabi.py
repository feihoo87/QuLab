...
def depends():
    return [('templates/spec.py', 'run/spec/${qubit}.py', {'qubit': '$qubit'})]
...
def analyze(report: Report, history: Report | None) -> Report:
    import random
    ...
    report.parameters = {'gate.R.${qubit}.params.amp': 1}
...
def check_analyze(report: Report, history: Report) -> Report:
    import random
