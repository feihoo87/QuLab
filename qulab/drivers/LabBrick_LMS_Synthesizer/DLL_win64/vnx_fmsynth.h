...
//
//	8/2013	RD	Support added for new devices, GetDLLVersion function
...
#define PLL_LOCKED			0x00000040		// set if the PLL lock status is TRUE
...
VNX_FSYNSTH_API int fnLMS_GetDLLVersion();
